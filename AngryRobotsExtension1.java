...
public class AngryRobotsExtension1{
   ...
   public static final String[] gravity = {"mercury", "venus", "mars", "jupiter", "saturn", "uranus", "neptune", "pluto"};
   ...
   public static void main(String[] args){
      ...
      String planet = (String)JOptionPane.showInputDialog(null,"Choose an map.", "Map Choices", JOptionPane.PLAIN_MESSAGE, null, gravity, gravity[0]);
